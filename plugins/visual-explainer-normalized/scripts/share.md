# Source Wrapper: share.sh

> Normalized skill ID: `visual-explainer:visual-explainer.scripts.share`
> Get this skill: `supercli skills get visual-explainer:visual-explainer.scripts.share`
> Original source path: `plugins/visual-explainer/scripts/share.sh`
