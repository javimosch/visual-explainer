> Normalized skill ID: `visual-explainer:visual-explainer.commands.diff-review`
> Get this skill: `supercli skills get visual-explainer:visual-explainer.commands.diff-review`
