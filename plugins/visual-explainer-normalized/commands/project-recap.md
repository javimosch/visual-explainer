> Normalized skill ID: `visual-explainer:visual-explainer.commands.project-recap`
> Get this skill: `supercli skills get visual-explainer:visual-explainer.commands.project-recap`
