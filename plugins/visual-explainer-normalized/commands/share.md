> Normalized skill ID: `visual-explainer:visual-explainer.commands.share`
> Get this skill: `supercli skills get visual-explainer:visual-explainer.commands.share`
...
```bash
bash {{skill_dir}}/visual-explainer:visual-explainer.scripts.share (get: supercli skills get visual-explainer:visual-explainer.scripts.share) <file>
```
