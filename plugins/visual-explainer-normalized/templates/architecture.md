# Source Wrapper: architecture.html

> Normalized skill ID: `visual-explainer:visual-explainer.templates.architecture`
> Get this skill: `supercli skills get visual-explainer:visual-explainer.templates.architecture`
> Original source path: `plugins/visual-explainer/templates/architecture.html`
